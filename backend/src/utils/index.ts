...
import {loadAccount} from './util/accounts';
...
export class TokenSwap {
  ...
  static async createTokenSwap(
    ...
    const confirmOptionss:ConfirmOptions = {
      commitment: 'confirmed', // Or you can use 'recent' or 'max' depending on your requirements
      preflightCommitment: 'confirmed',
      skipPreflight: false, // Set to false to ensure preflight checks are performed
    };
